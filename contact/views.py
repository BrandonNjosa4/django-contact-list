...
def editContact(request, pk):
    ...
    if request.method == 'POST':
        contact.full_name = request.POST.get('fullname', False)
        contact.relationship = request.POST.get('relationship', False)
        contact.email = request.POST.get('e-mail', False)
        contact.phone_number = request.POST.get('phone-number', False)
        contact.address = request.POST.get('address', False)
        contact.save()
